...
### Datasets 
Our data came from two sources. We fetched USDC Token's daily transaction data using the GraphQL language on hhttps://thegraph.com/explorer/subgraph/uniswap/uniswap-v2 - automatic!
